    ...
    this.menu = [
      {
        ...
        modulos: [
          ...
          { permiso: 'ygwsEwz3cUw4yVMCeaQ9hVMCFXUHri5q', icono: 'assets/catalogo-programas.svg', titulo: 'Parámetros globales', url: '/catalogos-parametros/configuracion-general'}, 
