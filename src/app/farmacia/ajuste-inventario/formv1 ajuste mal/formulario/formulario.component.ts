...
export class FormularioComponent {
  ...
  check_option(event, i){
    ...
    console.log(this.lista_de_lotes[i]);
  }
  ...
  guardar_movimiento(){
    ...
    var existe = false;
    console.log(this.lista_de_lotes);
    
    for(let item of this.lista_de_lotes){
      console.log(item);
    }
  }
  /**
  ...
  agregarLoteIsumo() {
    ...
    var lotes = {
      ...
      "nueva_existencia": ['', [Validators.required]],
  ...
  /**
     ...
     */
  agregarNuevoLote() {
    this.lotes_insumo.push({ id: "" + Math.floor(Math.random() * (999)) + 1, lote: "", codigo_barras: "", fecha_caducidad: "", existencia: '', nueva_existencia: '', nuevo: 1, ajuste:1 });
    console.log(this.lista_de_lotes);
  }
