...
const routes: Routes = [
  { path: 'almacen/pedidos', redirectTo: '/almacen/pedidos/todos', pathMatch: 'full' },
  {
    ...
    children: [
      ...
      { path: 'extraordinarios', component: ListaComponent },
      { path: 'extraordinarios/todos', component: ListaComponent },
      { path: 'extraordinarios/por-aprobar', component: ListaComponent },
      { path: 'extraordinarios/aprobados', component: ListaComponent },
      { path: 'extraordinarios/borradores', component: ListaComponent },
