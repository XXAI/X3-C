...
@Component({
  selector: 'buscar-insumo-stock',
  templateUrl: './buscar-insumo-stock.component.html',
  styleUrls: ['./buscar-insumo-stock.component.css'],
  host: { '(document:keydown)' : 'keyboardInput($event)'}
})

export class BuscarInsumoStockComponent implements OnInit, AfterViewInit {
 ...
 // mensajeExito: Mensaje = new Mensaje();
  ...
  constructor(private buscarInsumosService: BuscarInsumoStockService) { }
