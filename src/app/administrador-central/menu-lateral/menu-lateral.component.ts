  ...
  ngOnInit() {
    ...
    this.menu = [
      ...
      },
      {
        titulo: 'Operaciones',
        modulos: [
          { permiso: 'nkzKZXncGYTJVhn0V6aej6UiZGK42dgH', icono: 'fa-money', titulo:"Presupuesto", url:"/administrador-central/presupuesto" },
      ...
      },
      {
        ...
        modulos: [
          ...
          { permiso: 'r1RX6Yq7fc4CRRI2OJXIPxeBLW3lFP59', icono: 'fa-inbox', titulo:"Solicitudes de  pedidos", url:"/administrador-central/solicitudes-pedidos-extraordinarios" },
